...
def get_slot_selection_keyboard(slots: List) -> InlineKeyboardMarkup:
    buttons = []
    for slot in slots:
...
def get_period_start_date_keyboard() -> InlineKeyboardMarkup:
...
def get_period_end_date_keyboard(start_date_str: str) -> InlineKeyboardMarkup:
